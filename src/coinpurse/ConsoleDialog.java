...
/** 
 * User Interface for the monetary objects Purse. 
...
public class ConsoleDialog {
	...
	public void depositDialog() {
		System.out.print("Enter value of monetary object(s) to deposit on one line [eg: 5 5 1]: ");
		...
		while( scanline.hasNextDouble() ) {
			...
			try{
				val = MoneyFactory.getInstance().createMoney(value);
